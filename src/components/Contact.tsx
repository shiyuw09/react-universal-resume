          ...
          <ul className="list-inside pr-7">
            ...
            <li className="mt-1.5 leading-normal text-gray-700 text-md">
              <a
                ...
                target="_blank"
              >
                <Github className="w-5 inline-block text-gray-550 print:text-black font-normal group-hover:text-gray-700 transition duration-100 ease-in" />
            ...
            <li className="mt-1.5 leading-normal text-gray-700 text-md">
              ...
              >
                <Mail className="w-5 inline-block text-gray-550 print:text-black font-normal group-hover:text-gray-700 transition duration-100 ease-in" />
                <span className="group-hover:underline">
